...
<div class="container">
 ...
 ini_set( "display_errors", 0);
ob_start();
mysql_connect("electronics123.db.10816090.hostedresource.com", "electronics123", "S!rikhs123")or die("cannot connect"); 
mysql_select_db("electronics123")or die("cannot select DB");
...
$display = mysql_query("SELECT * FROM answers ORDER BY id");    
...
$sql="update quiz set score='$score' where username='$username'";
 mysql_query($sql);
echo "<p align=center><b>Thank you for your participation</b></p>";    
echo "<p>";    

$add="INSERT INTO $tbl_name(username, fscore) values('$username', '$score');";
mysql_query($add);
