...
<div class="container">
 ...
 ini_set( "display_errors", 0);
ob_start();
mysql_connect("onlineaptitude.db.10816090.hostedresource.com", "onlineaptitude", "S!rikhs123")or die("cannot connect"); 
mysql_select_db("onlineaptitude")or die("cannot select DB");
