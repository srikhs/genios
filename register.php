...
<div class="jumbotron masthead">
	...
	<li class="active"><a href="register.php">Register</a></li>
			 ...
			 <li><a href="contact.html">Contact</a></li> 
              <li><a href="codeofethics.html">IEEE Code of Ethics</a></li> 
					...
					<div class="span12">
						...
						<div class="tagline_text">
							...
							<div class="tag_list">
											    ...
											    <center>
	<h4>The General Registrations of Genios 13 have been Closed</h4><br>
    <h4>People who have already registered can login with their id when the event begins. Others have to register separately for the events! </h4>
