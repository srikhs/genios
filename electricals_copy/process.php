...
<div class="container">
 ...
 ini_set( "display_errors", 0);
ob_start();
mysql_connect("electricals123.db.10816090.hostedresource.com", "electricals123", "S!rikhs123")or die("cannot connect"); 
mysql_select_db("electricals123")or die("cannot select DB");
...
$res="update quiz set count='$count'  where username='$username'";
mysql_query($res);
