...
if(!isset($_SESSION["start_time9"])){$_SESSION["start_time9"] = mktime(date('G'),date('i'),date('s'),date('m'),date('d'),date('Y')) + $time_limit;} 
?>
...
function calculate_time()
{
 ...
 var end_time = "<?php echo $_SESSION["start_time9"]; ?>"; 
 var dt = new Date(); 
