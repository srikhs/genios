...
</div><center><h1>LeaderBoard</h1></center>
...
<div class="container">
	...
	<div class="row">
		<div class="span2">
            ...
            <a class="btn btn-large btn-block btn-inverse" href="leaderboard.php">Leaderboard</a><br>
...
echo "<table border='1' width='800'>";
	...
	echo "<th align='center'>" . "College" . "</th>";
        echo "<th align='center'>" . "Score" . "</th>";
         echo "<th align='center'>" . "Region" . "</th>";
	echo "</tr>";
	$position = 1;
...
for ($i=1; $i<=500; $i++)
  {
	$row = mysql_fetch_assoc($result); 	
				...
				{
				echo "<tr>";
				echo "<td align='center'>" . $position . "</td><td align='center'>". $row['dname'] . "</td><td align='center'> " . $row['college'] . "</td><td align='center'> " . $row['score'] . "</td><td align='center'> " . $row['reg'] . "</td>";
				echo "</tr>";
				$temp = $row['score'];
				$position++;
				continue;
