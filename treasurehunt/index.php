...
<div class="container">
	...
	<div class="row">
		<div class="span3">
            ...
            <a class="btn btn-large btn-block btn-inverse" href="leaderboard.php">Leader Board</a><br>
		...
		<div class="span8">
			...
			<center> <STRONG>For Clues Visit <a href="https://www.facebook.com/IEEEGeniOS" target="_blank"> Our Facebook Page</a></STRONG>     <br>
			    				
We are the Gods here. We can conjure or eliminate any rule, any time.
<br><br>
			 <!--   <?php	
                    include 'database.php';
                    $count = mysql_num_rows(mysql_query("select * from members")); 
                 echo  "<b>".$count."</b>";echo " Hunters playing";
                 echo "<br>"
                    ?>-->
						 	<a href="main_login.php"><img src="login-b.jpg" ></a>&nbsp;&nbsp;&nbsp;&nbsp;<br><br>
								<a href="register.php"><img src="register.jpg"></a><br>
                  </center>
		</div>
	</div>
</div>
