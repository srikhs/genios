...
<title>TREASURE HUNT - GENIOS 13 - ONLINE SYMPOSIUM - IEEE MADRAS SECTION STUDENT NETWORK</title>
...
</div><center><h1>Treasure Hunt</h1></center>
...
<div class="container">
	...
	<div class="row">
		<div class="span3">
			<aside>
			<a class="btn btn-large btn-block btn-success" href="index.php">Home</a>
			<a class="btn btn-large btn-block btn-primary" href="rules.html">Rules</a><a class="btn btn-large btn-block btn-inverse" href="leaderboard.php">Leaderboard</a><a class="btn btn-large btn-block btn-success" href="logout.php">Log Out</a><br>
	...
	<br>
		...
		<div class="span8">
			...
			<center> 
			<img src="questions/888.jpg"><br><br>  <!--Question Number-->
	
	<form name="form1" method="post" action="aswers.php">
		<!--Value Number-->  <center><label for="answer"><input type="hidden" name="question" id="question" value="31"><h4>Answer:</h4> </label><input name="answer" type="text" id="answer" >
                  </center></form>
		</div>
	</div>
</div>
