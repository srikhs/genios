...
</div><center><h1>Search Engine Hunt</h1></center>
...
<div class="container">
	...
	<div class="row">
		<div class="span3">
            ...
            <a class="btn btn-large btn-block btn-inverse" href="leaderboard.php">Leader Board</a>
            <a class="btn btn-large btn-block btn-success" href="logout.php">Log Out</a><br><br>
...
{
	echo "<strong>YOU ARE WRONG.</strong> Try again!!! A backspace will help you to try again! <br>";
    echo "<br>";
