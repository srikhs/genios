...
<div class="container">
	...
	<br>
		...
		<div class="span8">
			...
			<center> 
			<img src="questions/37.jpg"><br><br>  <!--Question Number-->
	
	<form name="form1" method="post" action="aswers.php">
		<!--Value Number-->  <center><label for="answer"><input type="hidden" name="question" id="question" value="37"><h4>Answer:</h4> </label><input name="answer" type="text" id="answer" >
                  </center></form>
		</div>
	</div>
</div>
